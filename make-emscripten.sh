...
$EMCC -O3 --memory-init-file 0 --pre-js ../../../emscripten-preamble.js --post-js ../../../emscripten-postamble.js -s EXPORTED_FUNCTIONS='["_yo", "_unyo", "_eightQueens", "_freeBytes", "_countLines"]' -s TOTAL_MEMORY=67108864 -s NO_BROWSER=1 -s NO_FILESYSTEM=1 -s NO_DYNAMIC_EXECUTION=1 minisatp.bc -o minisatp.js
popd
